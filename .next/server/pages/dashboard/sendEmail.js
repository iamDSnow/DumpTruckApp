...
function SendEmail({ data , error  }) {
    ...
    react__WEBPACK_IMPORTED_MODULE_2___default().useEffect(()=>{
        ...
        if (pathname === "/dashboard/sendEmail") {
            next_router__WEBPACK_IMPORTED_MODULE_4___default().push("/dashboard/sendEmail/" + ticketData.substring(1));
        }
    });
...
var __webpack_exports__ = __webpack_require__.X(0, [311,675,461], () => (__webpack_exec__(6145)));
